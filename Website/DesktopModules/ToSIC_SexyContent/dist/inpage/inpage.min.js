...
__webpack_require__.d(__webpack_exports__, {
  ...
  "iconPrefix": () => (/* reexport */ iconPrefix),
  "tlbI18nPrefix": () => (/* reexport */ tlbI18nPrefix)
});
...
var ToSxcName = "2sxc";
/** @internal */
var constants_SxcVersion = "16.07.00";
/** @internal */
...
var msgIntro = 'This is the $2sxc JS Insights - see https://go.2sxc.org/insights \n'
...
var SxcWebApi = /** @class */ (function () {
    ...
    SxcWebApi.prototype.fetchRaw = function (url, data, method) {
        ...
        return fetch(url, __assign({ headers: headers, method: method }, (data && { body: data })));
    };
    ...
    SxcWebApi.prototype.headers = function (method) {
        var headers = this.sxc.http.headers(this.sxc.id, this.sxc.cbid, this.sxc.ctx);
        if (!method) {
            return headers;
        }
...
var sxc_assign = (undefined && undefined.__assign) || function () {
    sxc_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return sxc_assign.apply(this, arguments);
};
...
var sxc_Sxc = /** @class */ (function (_super) {
    ...
    ctx) {
        ...
        var envAndHttp = _this.loadEnv(root);
        _this.env = envAndHttp.env;
        _this.http = envAndHttp.http;
     ...
     * @returns
     */
    Sxc.prototype.loadEnv = function (root) {
        var _a, _b;
        var localEnv = (_b = (_a = this.manage) === null || _a === void 0 ? void 0 : _a.editContext) === null || _b === void 0 ? void 0 : _b.JsApi;
        if (!localEnv)
            return { env: root.env, http: root.http };
        var rootEnv = root.env.headers;
        var final = localEnv ? sxc_assign(sxc_assign({}, rootEnv), localEnv) : rootEnv;
        var env = new sxc_global_environment_SxcGlobalEnvironment();
        env.load(final, 'sxc-instance');
        return { env: env, http: new sxc_global_http_SxcGlobalHttp(env) };
    };
    /**
...
function buildSxcRoot() {
    ...
    console.log("$2sxc ".concat(SxcVersion, " with insights-logging - see https://go.2sxc.org/insights"));
    return merged;
}
/** @internal */
...
(function (DialogPaths) {
    DialogPaths["quickDialog"] = "dist/quick-dialog/";
...
var ContextOfContentBlock = /** @class */ (function () {
    function ContextOfContentBlock(editCtx) {
        ...
        this.edition = (_a = cb.Edition) !== null && _a !== void 0 ? _a : null;
...
var ContextOfSystem = /** @class */ (function () {
    function ContextOfSystem(editCtx) {
        var _a;
        this.problems = (_a = editCtx.error) === null || _a === void 0 ? void 0 : _a.problems;
        if (editCtx.error) {
 ...
 * @internal
 */
var ContextErrorJsonAndObj = /** @class */ (function () {
    function ContextErrorJsonAndObj() {
    }
    return ContextErrorJsonAndObj;
}());
 ...
 * @internal
 */
var ContextProblems = /** @class */ (function () {
...
var ContextComplete = /** @class */ (function (_super) {
     ...
     */
    ContextComplete.getRule = function (ctx) {
        var _a, _b, _c;
        return (_c = (_b = (_a = ctx.toolbar) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0 ? void 0 : _b._rules) === null || _c === void 0 ? void 0 : _c.find(ctx.button.id);
    };
    /**
...
var command_assign = (undefined && undefined.__assign) || function () {
    command_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return command_assign.apply(this, arguments);
};



var iconPrefix = 'icon-sxc-';
var tlbI18nPrefix = 'Toolbar.';
var debugTippy = Debug.parts.CommandTippy;
/**
 * @internal
 */
var Command = /** @class */ (function () {
    ...
    Command.prototype.mergeDefaults = function (translateKey, icon, uiOnly, partOfPage, more) {
        ...
        this.buttonDefaults = command_assign({ icon: function () { return "".concat(iconPrefix).concat(icon); }, title: function () { return "".concat(tlbI18nPrefix).concat(translateKey); }, uiActionOnly: function () { return uiOnly; }, partOfPage: function () { return partOfPage; }, color: function () { return undefined; }, tippy: function (ctx, tag) {
                var _a, _b;
                var ui = (_a = ContextComplete.getRule(ctx)) === null || _a === void 0 ? void 0 : _a.ui;
                var note = ui === null || ui === void 0 ? void 0 : ui.note;
                if (!(note === null || note === void 0 ? void 0 : note.note))
                    return undefined;
                var allowHtml = (_b = note === null || note === void 0 ? void 0 : note.allowHtml) !== null && _b !== void 0 ? _b : false;
                var tippyProps = {
                    content: note.note,
                    theme: 'light',
                    arrow: true,
                    ...
                    onMount: function (instance) {
                        if (!(note === null || note === void 0 ? void 0 : note.background))
                            return;
                ...
                // Experimental 16.02
                if (note.interactive)
                    tippyProps = _this.tippyMakeInteractive(tippyProps);
                tippyProps = _this.tippyAddLinks(tippyProps, note);
                if (debugTippy)
                    console.log('Command-Tippy', note, tippyProps);
                tippy_esm(tag, tippyProps);
                return undefined;
            } }, more);
    };
    Command.prototype.tippyAddLinks = function (tippyProps, note) {
        if (!note.links || note.links.length === 0)
            return tippyProps;
        var html = note.links.map(function (l) { var _a; return "<a class=\"tippy-button ".concat(l.primary ? 'tippy-button-primary' : '', "\" href=\"").concat(l.url, "\" target=\"_blank\">").concat((_a = l.label) !== null && _a !== void 0 ? _a : '🔗 more', "</a>"); });
        return command_assign(command_assign({}, this.tippyMakeInteractive(tippyProps)), { allowHTML: true, content: "<div>".concat(note.note, "<div>\n      <br>\n      <div class=\"tippy-buttons\">").concat(html, "</div>") });
    };
    Command.prototype.tippyMakeInteractive = function (tippyProps) {
        return command_assign(command_assign({}, tippyProps), { interactive: true, appendTo: function () { return document.body; } });
    };
    /**
     *
     * @returns
...
(function (QuickEditOverlay) {
    ...
    function btn(action, icon, i18N, invisible, unavailable, classes) {
        return "<a class='sc-content-block-menu-btn sc-cb-action ".concat(iconPre).concat(icon, " ").concat(invisible ? ' sc-invisible ' : '').concat(unavailable ? " ".concat(C.ClsNames.UnAvailable, " ") : '').concat(classes, "' data-action='").concat(action, "' data-i18n='[title]QuickInsertMenu.").concat(i18N, "'></a>");
    }
...
var ToolbarSettings = /** @class */ (function () {
    ...
    ToolbarSettings.getDefaults = function () { return new ToolbarSettings({ autoAddMore: TLB_MORE_AUTO, hover: TLB_HOV_RIGHT, show: TLB_SHOW_HOVER, follow: followDefault }); };
    /** Setup for situations where an empty toolbar is needed, without any data or configuration */
    ToolbarSettings.getForEmpty = function () { return new ToolbarSettings({ autoAddMore: TLB_MORE_AUTO, hover: TLB_HOV_LEFT, show: TLB_SHOW_HOVER, follow: followDefault }); };
    ToolbarSettings.getForEmptyAsRule = function () { return "settings&autoAddMore=".concat(TLB_MORE_AUTO, "&hover=").concat(TLB_HOV_LEFT, "&show=").concat(TLB_SHOW_HOVER, "&follow=").concat(followDefault); };
...
var TagToolbar = /** @class */ (function () {
    ...
    function TagToolbar(hoverTag, context, translator) {
        ...
        this.delayShow = (_a = settings.delayShow) !== null && _a !== void 0 ? _a : 0;
    ...
    TagToolbar.prototype.addMouseEvents = function (hoverTag) {
        ...
        hoverTag.addEventListener('mouseenter', function () {
            if (_this.delayShow == 0)
                _this.show();
            else
                _this.delayShowTimeout = setTimeout(function () { _this.show(); }, _this.delayShow);
        });
        if (!this.alwaysShow)
            hoverTag.addEventListener('mouseleave', function (e) {
                // new 16.04
                if (_this.delayShowTimeout)
                    clearTimeout(_this.delayShowTimeout);
...
var ButtonSafe = /** @class */ (function () {
    function ButtonSafe(button, context) {
         ...
         */
        this.color = function () { return getVal(_this.button.color, _this.context, undefined); };
        ...
        this.tippy = function (context, tag) { var _a, _b; return (_b = (_a = _this.button).tippy) === null || _b === void 0 ? void 0 : _b.call(_a, context, tag); };
...
;// CONCATENATED MODULE: ./src/constants/rules.ts
var prefixBase64 = 'base64:';
var prefixJson64 = 'json64:';

;// CONCATENATED MODULE: ./src/toolbar/config/toolbar-button-settings.ts
...
var Note = /** @class */ (function () {
    ...
    Note.toJson64String = function (note) {
        return "".concat(prefixJson64).concat(window.btoa(JSON.stringify(note)));
    };
    return Note;
}());
...
var RenderButton = /** @class */ (function (_super) {
    ...
    RenderButton.prototype.render = function (ctx, groupIndex) {
        ...
        var rule = ContextComplete.getRule(ctx);
        if (rule)
        ...
        var group = (_c = (_b = ctx.toolbar) === null || _b === void 0 ? void 0 : _b.groups) === null || _c === void 0 ? void 0 : _c[groupIndex];
        ...
        var classes = (disabled ? " disabled" : "") +
            ...
            " " +
            ((_d = rule === null || rule === void 0 ? void 0 : rule.ui.class) !== null && _d !== void 0 ? _d : "") +
            " " +
            ((_e = rule === null || rule === void 0 ? void 0 : rule.ui.classes) !== null && _e !== void 0 ? _e : "") +
            " " +
            btnSafe.classes() +
            " " +
    ...
    RenderButton.prototype.setTitle = function (rule, btnLink, btn) {
        ...
        if (uiTitle) {
            if (uiTitle.indexOf("i18n:") === 0) {
                var i18nTitle = uiTitle.substring(5);
    ...
    RenderButton.prototype.processColorRules = function (btn, rule, ctx, divTag) {
        var _a, _b, _c;
        var callLog = this.log.call("processColorRules");
        var color = (_c = (_b = (_a = rule === null || rule === void 0 ? void 0 : rule.ui) === null || _a === void 0 ? void 0 : _a.color) !== null && _b !== void 0 ? _b : btn.color()) !== null && _c !== void 0 ? _c : ctx.toolbar.settings.color;
    ...
    RenderButton.prototype.generateRunJs = function (rule, ctx, params) {
        ...
        var targetContext = modifyContext
            ? JSON.stringify(modifyContext)
            : "".concat(ctx.instance.id, ", ").concat(ctx.contentBlockReference.id);
        ...
        if ((params === null || params === void 0 ? void 0 : params.action) === "code" /* CommandNames.code */) {
            var action = params.action, cleanParams = __rest(params, ["action"]);
...
;// CONCATENATED MODULE: ./src/toolbar/templates/toolbar-when-no-toolbar-provided.ts

/**
 * @internal
 */
function getToolbarWhenNoneProvided() {
    var toolbar = [ToolbarSettings.getForEmptyAsRule()];
    return {
        toolbar: toolbar,
    };
}
...
var RuleParamsHelper = /** @class */ (function () {
    ...
    RuleParamsHelper.processParams = function (params, log) {
        ...
        var formParams = RuleParamsHelper.extractSubKeys(params, formPrefix, log);
        if (formParams)
...
var TemplateEditor = /** @class */ (function (_super) {
    ...
    TemplateEditor.prototype.add = function (template, rules) {
        var _this = this;
        rules.forEach(function (r) {
            if (r.step === BuildSteps.group)
                _this.addGroup(template, r.name, r.pos);
            else
                _this.addButton(template, r.group, r.id, r.name, r.pos);
        });
    };
...
var BuildRule = /** @class */ (function (_super) {
    ...
    BuildRule.Create = function (_a) {
        var name = _a.name, ui = _a.ui, params = _a.params, pos = _a.pos, log = _a.log;
        var rule = new BuildRule('', log);
        rule.name = name;
        rule.ui = ui !== null && ui !== void 0 ? ui : {};
        rule.operator = Operations.add;
        rule.setIdBasedOnOperation(rule.name);
        rule.params = params !== null && params !== void 0 ? params : {};
        if (pos)
            rule.pos = pos;
        return rule;
    };
    ...
    BuildRule.prototype.setIdBasedOnOperation = function (key) {
...
var InsightsApiRoot = 'sys/insights';
function insightsUrl(part) {
    return window.$2sxc.http.apiUrl("".concat(InsightsApiRoot, "/").concat(part));
}
/**
 * import this module to commands.ts
 * @internal
 */
var cmd = Command.build("insights" /* CommandNames.insights */, 'Insights', 'speed', true, false, {
    ...
    code: function (context, event) {
        var _a, _b;
        var path = insightsUrl((_b = (_a = context.button.command.params) === null || _a === void 0 ? void 0 : _a.part) !== null && _b !== void 0 ? _b : 'logs');
        return new Promise(function (resolve) {
...
Commands.addCommand(Command.clone(cmd, "insights-server" /* CommandNames.insights_old_server */));

;// CONCATENATED MODULE: ./src/toolbar/rules/rules-obsolete-code.ts
var rules_obsolete_code_assign = (undefined && undefined.__assign) || function () {
    rules_obsolete_code_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return rules_obsolete_code_assign.apply(this, arguments);
};


var thingPlaceholder = 'thing-to-replace';
...
var ripButton = {
    ...
    icon: iconBug,
    note: {
        note: "<strong>Obsolete Code detected in this ".concat(thingPlaceholder, "</strong>\n    <br>\n    This uses obsolete code which will be removed soon. You should fix the code so it won't break on a future update."),
        allowHtml: true,
    },
};
var codeObsolete = 'obsolete';
var appCodeObsolete = 'obsolete-app';
/**
 * Add buttons to warn about obsolete code
 */
function addStandardObsoleteButtons(log, problems, appId) {
    // If any of the problems report 'obsolete'
    // add a special button and then skip those problems
    var rules = [];
    if (problems.find(function (p) { return p.code === codeObsolete; }) !== undefined)
        rules.push(createButtonForObsolete(log, appId, 'Razor', 'red'));
    else if (problems.find(function (p) { return p.code === appCodeObsolete; }) !== undefined)
        rules.push(createButtonForObsolete(log, appId, 'App', null));
    var remaining = problems.filter(function (p) { return p.code !== codeObsolete && p.code != appCodeObsolete; });
    return [remaining, rules];
}
function createButtonForObsolete(log, appId, thing, color) {
    return BuildRule.Create({
        name: "insights" /* CommandNames.insights */,
        ui: rules_obsolete_code_assign(rules_obsolete_code_assign({}, ripButton), { color: color !== null && color !== void 0 ? color : ripButton.color, note: rules_obsolete_code_assign(rules_obsolete_code_assign({}, ripButton.note), { links: [
                    {
                        url: insightsUrl("logs?key=warnings-obsolete&filter=AppId=".concat(appId)),
...
var rule_manager_debug = Debug.parts.RuleManager;
var throwOnError = true;
var devInfoButtonsIndex = 20;
/**
 * @internal
 */
var RuleManager = /** @class */ (function (_super) {
     ...
     * @returns
     */
    RuleManager.prototype.addDeveloperInfos = function (context) {
        var _this = this;
        // Skip if already added
        if (this.debugAdded)
            return;
        // Skip if no problems reported
        var hasErr = !!context.system.error;
        if (hasErr) {
            var note = new Note();
            note.note = '<strong>Server Insights Logs</strong> can help <br> you debug server errors.';
            note.allowHtml = true;
            this.rules.push(BuildRule.Create({ name: "insights" /* CommandNames.insights */, ui: { note: note, color: 'red' }, pos: 10, log: this.log }));
        }
        // Get any other problems and stop if none found
        var problems = context.system.problems;
        if (!((problems === null || problems === void 0 ? void 0 : problems.length) > 0))
            return;
        // If any of the problems report 'obsolete'
        // add a special button and then skip those problems
        var _a = addStandardObsoleteButtons(this.log, problems, context.app.id), remaining = _a[0], newRules = _a[1];
        problems = remaining;
        newRules.forEach(function (r) { return _this.rules.push(r); });
        // Add warning/info buttons provided by the context - new v16.02
        if (rule_manager_debug)
            console.log('2dm - has problems', problems);
        // create rules to add the buttons for all remaining problems
        var rules = problems.map(function (p, i) {
            var _a;
            var note = new Note();
            note.note = (_a = p.message) === null || _a === void 0 ? void 0 : _a.replace('\n', '<br>');
            if (p.link)
                note.links = [{ url: p.link, label: 'see docs', primary: true }];
            note.type = p.severity;
            note.allowHtml = true;
            note.interactive = true;
            return BuildRule.Create({ name: "info" /* CommandNames.info */, ui: { note: note }, params: { link: p.link }, pos: devInfoButtonsIndex + i, log: _this.log });
        });
        if (rule_manager_debug)
            console.log('2dm - rules', rules);
        rules.forEach(function (r) { return _this.rules.push(r); });
    };
...
var ToolbarConfigLoaderV09 = /** @class */ (function (_super) {
    ...
    function ToolbarConfigLoaderV09(configLoader) {
        var _this = _super.call(this, 'Tlb.TlbV09', configLoader.log) || this;
        _this.configLoader = configLoader;
        _this.rules = new RuleManager(configLoader);
        return _this;
    }
    ToolbarConfigLoaderV09.prototype.loadV9 = function (context, config) {
        ...
        var draftToolbar = this.getTemplateIfNoButtonsSpecified(context, config.toolbar);
     ...
     */
    ToolbarConfigLoaderV09.prototype.getTemplateIfNoButtonsSpecified = function (context, raw) {
        ...
        var template = this.configLoader.templates.copy(defToolbarname);
        ...
        var addRules = this.rules.getAdd();
    ...
    toolbarSettings) {
        ...
        var result = this.configLoader.buildTreeAndModifyAccordingToRules(toolbarContext, configWip);
        // New v16.02
    ...
    ToolbarConfigLoaderV09.prototype.ensureDefinitionTree = function (unstructuredConfig, toolbarSettings) {
        var l = this.log.call('ensureDefinitionTree');
    ...
    ToolbarConfigLoaderV09.prototype.findGroups = function (unstructuredConfig) {
        var l = this.log.call('findGroups');
        ...
        if (Array.isArray(unstructuredConfig)) {
            ...
            if (InPageButtonJson.is(unstructuredConfig[0]))
                return l.return([{ buttons: unstructuredConfig }], '2b: is list of buttons, return 1 group');
        ...
        if (InPageButtonJson.is(unstructuredConfig)) {
            return l.return([{ buttons: [unstructuredConfig] }], 'Case 3a: not array, but has action/buttons properties, will wrap config into array');
        }
...
var toolbar_config_loader_v10_debug = Debug.parts.ToolbarConfigLoaderV10;
/**
 * @internal
 */
var ToolbarConfigLoaderV10 = /** @class */ (function (_super) {
    toolbar_config_loader_v10_extends(ToolbarConfigLoaderV10, _super);
    function ToolbarConfigLoaderV10(configLoader) {
        var _this = _super.call(this, 'Tlb.TlbV10', configLoader.log, 'constructor') || this;
        _this.configLoader = configLoader;
        _this.rules = new RuleManager(configLoader);
        return _this;
    }
    ToolbarConfigLoaderV10.prototype.loadV10 = function (context, config, raw) {
        ...
        var toolbarTemplateName = (_b = toolbarRule === null || toolbarRule === void 0 ? void 0 : toolbarRule.name) !== null && _b !== void 0 ? _b : defToolbarname;
        var template = this.configLoader.templates.copy(toolbarTemplateName);
        template.settings = settings;
        if (params)
            template.params = params.params;
        // #4 Remove unwanted groups
        var removeGroups = this.rules.getRemoveGroups();
        removeGroups.forEach(function (rg) { return _this.configLoader.templateEditor.removeGroup(template, rg.name); });
        // Add additional buttons 16.02
        this.rules.addDeveloperInfos(context);
        var addRules = this.rules.getAdd();
        this.configLoader.templateEditor.add(template, addRules);
        // Build the real toolbar structure
        var toolbar = this.configLoader.buildTreeAndModifyAccordingToRules(context, template);
...
var ToolbarConfigLoader = /** @class */ (function (_super) {
    ...
    ToolbarConfigLoader.prototype.load = function (context, config) {
        var l = this.log.call('load', '', 'expand start', { context: context, config: config });
...
var RendererGlobal = /** @class */ (function (_super) {
    ...
    RendererGlobal.prototype.reloadAndReInitialize = function (context, forceAjax, preview) {
        ...
        var finalPromise = promiseChain.then(function (wfArgs) {
            ...
            var winForOqt = window;
            if ((_b = (_a = winForOqt.ToSic) === null || _a === void 0 ? void 0 : _a.Sxc) === null || _b === void 0 ? void 0 : _b.Oqtane) {
...
Commands.add("app-resources" /* CommandNames.appResources */, 'AppResources', 'translate', true, false, {
    ...
    title: function (context) { return "".concat(tlbI18nPrefix, "AppResources").concat(context.app.resourcesId === null ? 'Disabled' : ''); },
 ...
 * @internal
 */
var command_content_type_cmd = Command.build("fields" /* CommandNames.fields */, 'ContentType', 'fields', true, false, {
...
Commands.addCommand(command_content_type_cmd);
Commands.addCommand(Command.clone(command_content_type_cmd, "contenttype" /* CommandNames.fields_old_contenttype */));
/**
 * @internal
 */
...
var command_code_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
var command_code_cmd = Command.build("code" /* CommandNames.code */, 'Custom', 'bomb', true, false, {
    code: function (context, event) {
        return new Promise(function (resolve, reject) {
            ...
            var action = clean.action, call = clean.call, cleanest = command_code_rest(clean, ["action", "call"]); // remove 'action' and 'call'
            try {
...
;// CONCATENATED MODULE: ./src/commands/command/command-info.ts




var command_info_debug = Debug.parts.commandInfo;
var i18nKeys = {
    info: 'Info',
    warning: 'Warning',
    error: 'Error',
...
function getNote(ctx) {
    var _a, _b, _c, _d;
    if (command_info_debug)
        console.log('2dm - note: ctx-ui', ctx === null || ctx === void 0 ? void 0 : ctx.ui);
    var note = (_c = (_b = (_a = ContextComplete.getRule(ctx)) === null || _a === void 0 ? void 0 : _a.ui) === null || _b === void 0 ? void 0 : _b.note) !== null && _c !== void 0 ? _c : {};
    // Set type explicitly (spread operator wouldn't always work, because type could be null)
    note.type = (_d = note.type) !== null && _d !== void 0 ? _d : 'info';
    if (command_info_debug)
        console.log('2dm - note', note);
    return note;
}
/**
 * import this module to commands.ts
 * @internal
 */
Commands.add("info" /* CommandNames.info */, 'Info', 'info', true, false, {
    icon: function (ctx) { var _a; return iconPrefix + ((_a = icons[getNote(ctx).type]) !== null && _a !== void 0 ? _a : 'info'); },
    title: function (ctx) { var _a; return tlbI18nPrefix + ((_a = i18nKeys[getNote(ctx).type]) !== null && _a !== void 0 ? _a : 'Info'); },
    color: function (ctx) { var _a, _b; return colors[(_b = (_a = getNote(ctx)) === null || _a === void 0 ? void 0 : _a.type) !== null && _b !== void 0 ? _b : 'info']; },
    // TODO: improve call so params are always directly available
    code: function (context) {
        var _a;
        if (command_info_debug)
            console.log('2dm - info-button code', context);
        var link = (_a = context.button.command.params) === null || _a === void 0 ? void 0 : _a.link;
        if (command_info_debug)
            console.log('2dm - info-button code - link', link);
        if (link)
...
var command_query_cmd = Command.build("query" /* CommandNames.query */, 'QueryEdit', 'filter', true, false, {
    ...
    title: function (ctx) { return "".concat(tlbI18nPrefix, "QueryEdit").concat(ctx.contentBlock.queryId === null ? 'Disabled' : ''); },
...
var CommandLinkGenerator = /** @class */ (function (_super) {
    ...
    function CommandLinkGenerator(context, parentLog) {
        ...
        cl.data('urlParams', _this.urlParams);
    ...
    CommandLinkGenerator.prototype.getLink = function () {
        ...
        if (params.prefill)
            for (var i = 0; i < this.items.length; i++)
                this.addFieldsAndParameters(this.items[i], params);
    ...
    CommandLinkGenerator.prototype.getDialogUrl = function (context) {
        ...
        var env = (_b = (_a = context.sxc) === null || _a === void 0 ? void 0 : _a.env) !== null && _b !== void 0 ? _b : window.$2sxc.env;
    ...
    CommandLinkGenerator.prototype.addFieldsAndParameters = function (item, params) {
        if (params == null)
            return item;
        if (params.prefill)
            item.Prefill = params.prefill;
        if (params.uifields)
            item.UiFields = params.uifields;
        if (params.form)
            item.Parameters = params.form;
        return item;
    };
    /**
    ...
    CommandLinkGenerator.prototype.addContentGroupItems = function (withPresentation) {
        ...
        fields.map(function (f) { return _this.addContentGroupItem(groupId, index, f, isAdd, params); });
        cl.done();
    };
    /**
     * this adds an item of the content-group, based on the group GUID and the sequence number
     */
    CommandLinkGenerator.prototype.addContentGroupItem = function (guid, index, part, isAdd, params) {
    ...
    CommandLinkGenerator.prototype.addItemInList = function () {
        ...
        if (params.fields)
            params.fields.split(',').map(function (f) {
                var item = {
                ...
                _this.items.push(_this.addFieldsAndParameters(item, params));
            });
    };
    /**
...
var BootstrapInPage = /** @class */ (function (_super) {
    ...
    BootstrapInPage.prototype.showGlassesButtonIfUninitialized = function (sxci) {
        ...
        var btn = NoJQ.domFromString("<div class=\"".concat(C.ClsNames.UnInitialized, "\" onmouseover=\"this.title = $2sxc.translate(this.title)\" title=\"InPage.NewElement\">") +
            "<div class=\"".concat(iconPrefix, "glasses\"></div>") +
            '</div>')[0];
...
/******/ })()
;
//# sourceMappingURL=https://sources.2sxc.org/16.07.00/dist/inpage/inpage.min.js.map